...
# Mask slope > 30%
def slopeMask(image, geometry=geometry):
...
for i in range(7):
    ...
    cluster_name.append(f'Cluster_{i}')
    total_agb.append(totalAgb.getInfo())

final_data = {'Cluster': cluster_name, 'Total_AGB_Mg': total_agb}
import pandas as pd 
