from VulnerabilityMap import VulnerabilityMap
...
class RMT_FIT_CAL():
    ...
    def calculate_mrt(self):
        ...
        MRT = self.vulnerability_map.mrt_calculation(self.forest_edge_distance, self.deforestation_hrp, self.mask)
        self.MRT = MRT
    ...
    def prepare_maximum_risk_map(self):
        MRT = self.MRT
